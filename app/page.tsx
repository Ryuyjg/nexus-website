  ...
  return (
    <main className="min-h-screen bg-background selection:bg-accent/20">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 z-50"
        target="_blank" 
