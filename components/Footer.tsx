...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-white/15 bg-[linear-gradient(135deg,#07110d,#122019_54%,#241c12)] text-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid gap-10 py-14 sm:py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            ...
            <Link href="/" className="mt-6 flex items-center gap-3 font-display text-3xl font-semibold tracking-[-0.04em] text-white">
              <div className="flex h-12 w-16 items-center justify-center overflow-hidden rounded-2xl bg-white/90 px-2 shadow-lg shadow-accent/20">
