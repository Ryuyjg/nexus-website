...
export function Features() {
  ...
  return (
    <section id="features" className="relative overflow-hidden bg-[#fbf5eb] py-20 sm:py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 justify-center">
          {features.map((feature, index) => (
            <motion.div 
              ...
              className="group relative overflow-hidden rounded-[2rem] border border-[#e3d5bf] bg-[#fffaf1] p-6 shadow-[0_22px_70px_rgba(17,17,15,0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(17,17,15,0.12)] sm:p-8"
            >
              ...
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#f1e4cf] text-[#9e7434] ring-1 ring-[#e2d3bd] transition-colors group-hover:bg-[#07120d] group-hover:text-[#d9bd80] sm:mb-6 sm:h-16 sm:w-16">
                {feature.icon}
              </div>
